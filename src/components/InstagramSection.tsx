...
const InstagramSection = () => {
  ...
  return (
    <div>
      {/* Contact section with increased vertical spacing */}
      <section id="contact" className="relative py-36 lg:py-44 flex items-center justify-center mt-20 mb-20">
        {/* Background image with gradient overlay */}
        <div 
          className="absolute inset-0 bg-cover bg-center z-0" 
          style={{ 
            backgroundImage: "url('https://photos.smugmug.com/Portfolio/i-r3mKZZM/0/LQKKTPkXBk6HGd7cSv3d5FQvCjQ9RQTdZvQN7whf6/X3/20180619_221432-X3.jpg')",
          }}
        >
        ...
        <div className="relative z-10 text-center text-white max-w-2xl mx-auto px-4 py-16">
          <h2 className="text-5xl md:text-6xl font-light mb-8">Let's get in touch.</h2>
          <a 
            href="#inquiry" 
            className="inline-block bg-white text-black px-8 py-4 font-medium tracking-wide transition-transform hover:scale-105"
          >
            SUBMIT AN INQUIRY
          </a>
        </div>
      ...
      {/* Instagram Section */}
      <section id="social" className="py-24 bg-gray-50 mt-16">
